			...
			<xsl:element name="CcmFifCancelNonCompleteStpForProductCmd">
				<xsl:element name="command_id">find_cancel_stp_onl_1</xsl:element>
			...
			<xsl:element name="CcmFifConcatStringsCmd">
				<xsl:element name="command_id">concat_contract_type_bundle</xsl:element>
			...
			<xsl:element name="CcmFifCheckOnlyOnePCExistsCmd">
				...
				<xsl:element name="CcmFifCheckOnlyOnePCExistsInCont">
					...
					<xsl:element name="required_process_ind">Y_O</xsl:element>                    
				</xsl:element>
			</xsl:element>
			...
			<xsl:element name="CcmFifTerminateOrderFormCmd">
				<xsl:element name="command_id">terminate_of_onl_1</xsl:element>
			...
			<xsl:element name="CcmFifTerminateSDCProductCommitmentCmd">
				...
				<xsl:element name="CcmFifTerminateSDCProductCommitmentInCont">
					...
					<xsl:element name="required_process_ind">Y_S</xsl:element>
					<xsl:element name="multiple_ps_found_ref">
						<xsl:element name="command_id">check_ps_count_1</xsl:element>
						<xsl:element name="field_name">multiple_ps_found</xsl:element>           
					</xsl:element>
			...
			<xsl:element name="CcmFifTerminateProductSubsCmd">
				<xsl:element name="command_id">terminate_ps_onl_1</xsl:element>
			...
			<!-- Create Customer Order for Termination of the online product -->
			<xsl:element name="CcmFifCreateCustOrderCmd">
				<xsl:element name="command_id">create_co_onl_1</xsl:element>
				<xsl:element name="CcmFifCreateCustOrderInCont">
					...
					<xsl:element name="provider_tracking_no">002id</xsl:element>
			...
			<!-- Release Customer Order for Termination of the online  PS-->
