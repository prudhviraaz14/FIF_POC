...
nohup $JAVA_HOME/bin/java -Xmx1024m -Dfif.propertyfile=ISISMigrationDatabaseClient_RO -cp $CPATH net.arcor.fif.client.DatabaseClient  >/dev/null 2>&1 &

echo "\n--> Started all ISIS migration processes in read-only mode...\n"
