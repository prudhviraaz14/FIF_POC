@echo off
REM ---------------------------------------------------------------------------
REM NT script for launching the CleanQueue application
REM
REM $Author:   lejam  $
REM $Revision:   1.4  $
REM
REM History:
REM $Log:   //PVCS_FIF/archives/FIF_API/FIF/scripts/nt/runCleanQueue.cmd-arc  $
REM  
...
%JAVA_HOME%\bin\java -Dfif.propertyfile=%FIF_HOME%\etc\CleanQueue.properties -classpath %CP% net.arcor.fif.apps.CleanQueue %*
endlocal
