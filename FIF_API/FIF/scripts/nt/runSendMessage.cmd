...
REM
REM History:
REM $Log:   //PVCS_FIF/archives/FIF_API/FIF/scripts/nt/runSendMessage.cmd-arc  $
REM  
...
REM  
REM     Rev 1.2   Mar 03 2004 16:29:46   goethalo
...
%JAVA_HOME%\bin\java -Dfif.propertyfile=%FIF_HOME%\etc\SendMessage.properties -classpath %CP% net.arcor.fif.apps.SendMessage %*
endlocal
