@echo off
REM ---------------------------------------------------------------------------
REM NT script for launching the ReceiveMessage application
REM
REM $Author:   lejam  $
REM $Revision:   1.4  $
REM
REM History:
REM $Log:   //PVCS_FIF/archives/FIF_API/FIF/scripts/nt/runReceiveMessage.cmd-arc  $
REM  
...
REM  
REM     Rev 1.2   Mar 03 2004 16:29:44   goethalo
...
%JAVA_HOME%\bin\java -Dfif.propertyfile=%FIF_HOME%\etc\ReceiveMessage.properties -classpath %CP% net.arcor.fif.apps.ReceiveMessage %*
endlocal
