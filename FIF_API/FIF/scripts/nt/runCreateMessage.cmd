@echo off
REM ---------------------------------------------------------------------------
REM NT script for launching the CreateMessage application
REM
REM $Author:   lejam  $
REM $Revision:   1.4  $
REM
REM History:
REM $Log:   //PVCS_FIF/archives/FIF_API/FIF/scripts/nt/runCreateMessage.cmd-arc  $
REM  
REM     Rev 1.4   Aug 09 2007 16:39:32   lejam
...
%JAVA_HOME%\bin\java -Dfif.propertyfile=%FIF_HOME%\etc\CreateMessage.properties -classpath %CP% net.arcor.fif.apps.CreateMessage %*
endlocal
