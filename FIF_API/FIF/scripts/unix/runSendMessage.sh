#!/usr/bin/sh
# ---------------------------------------------------------------------------
# Shell script for launching the SendMessage application
#
# $Author:   lejam  $
# $Revision:   1.3  $
# 
# History:
# $Log:   //PVCS_FIF/archives/FIF_API/FIF/scripts/unix/runSendMessage.sh-arc  $
# 
...
$JAVA_HOME/bin/java -Dfif.propertyfile=$FIF_HOME/etc/SendMessage.properties -cp $CPATH net.arcor.fif.apps.SendMessage $@
