#!/usr/bin/sh
# ---------------------------------------------------------------------------
# Shell script for launching the CreateMessage application
#
# $Author:   lejam  $
# $Revision:   1.3  $
# 
# History:
# $Log:   //PVCS_FIF/archives/FIF_API/FIF/scripts/unix/runCreateMessage.sh-arc  $
# 
...
$JAVA_HOME/bin/java -Dfif.propertyfile=$FIF_HOME/etc/CreateMessage.properties -Dfif.propertyfile=example-createmessage -cp $CPATH net.arcor.fif.apps.CreateMessage $@
