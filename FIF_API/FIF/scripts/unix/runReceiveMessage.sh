#!/usr/bin/sh
# ---------------------------------------------------------------------------
# Shell script for launching the ReceiveMessage application
#
# $Author:   lejam  $
# $Revision:   1.3  $
# 
# History:
# $Log:   //PVCS_FIF/archives/FIF_API/FIF/scripts/unix/runReceiveMessage.sh-arc  $
# 
...
# 
#    Rev 1.1   Mar 02 2004 11:18:32   goethalo
...
$JAVA_HOME/bin/java -Dfif.propertyfile=$FIF_HOME/etc/ReceiveMessage.properties -Dfif.propertyfile=example-receivemessage -cp $CPATH net.arcor.fif.apps.ReceiveMessage $@
