		...
		<xsl:element name="Command_List">
			...
			<xsl:element name="CcmFifRaiseErrorCmd">
					...
					<xsl:element name="CcmFifRaiseErrorInCont">
						<xsl:element name="error_text">Dienst bereits gekündigt, Anrufweiterleitung muss nicht mehr entfernt werden</xsl:element>							
			...
			<xsl:element name="CcmFifRaiseErrorCmd">
					...
					<xsl:element name="CcmFifRaiseErrorInCont">
						...
						<xsl:element name="required_process_ind">TERMINATED</xsl:element>						
					</xsl:element>
			</xsl:element>		
