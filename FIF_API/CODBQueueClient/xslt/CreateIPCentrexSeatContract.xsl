...
<xsl:stylesheet exclude-result-prefixes="dateutils" version="1.0"
	...
	<xsl:template match="request-params">
		...
		<xsl:element name="Command_List">
			...
			<xsl:variable name="productCode">VI205</xsl:variable>
			...
			<xsl:variable name="serviceCode">
				<xsl:choose>
					<xsl:when test="request-param[@name='seatType'] = 'converged'">VI011</xsl:when>
					<xsl:when test="request-param[@name='seatType'] = 'fixed'">VI012</xsl:when>
					<xsl:when test="request-param[@name='seatType'] = 'mobile'">VI013</xsl:when>
				</xsl:choose>
			</xsl:variable>
			...
			<xsl:element name="CcmFifAddServiceSubsCmd">
				...
				<xsl:element name="CcmFifAddServiceSubsInCont">
					...
					<xsl:element name="service_code">
						<xsl:choose>
							<xsl:when test="request-param[@name='seatType'] = 'converged'
								and request-param[@name='isHardwareSubsidized'] = 'N'">VI050</xsl:when>
							<xsl:when test="request-param[@name='seatType'] = 'converged'
								and request-param[@name='isHardwareSubsidized'] = 'Y'">VI051</xsl:when>
							<xsl:when test="request-param[@name='seatType'] = 'fixed'
								and request-param[@name='isHardwareSubsidized'] = 'N'">VI052</xsl:when>
							<xsl:when test="request-param[@name='seatType'] = 'fixed'
								and request-param[@name='isHardwareSubsidized'] = 'Y'">VI053</xsl:when>
							<xsl:when test="request-param[@name='seatType'] = 'mobile'
								and request-param[@name='isHardwareSubsidized'] = 'N'">VI054</xsl:when>
							<xsl:when test="request-param[@name='seatType'] = 'mobile'
								and request-param[@name='isHardwareSubsidized'] = 'Y'">VI055</xsl:when>
						</xsl:choose>
					</xsl:element>
			...
			<xsl:element name="CcmFifModifyBundleItemCmd">
				...
				<xsl:element name="CcmFifModifyBundleItemInCont">
					...
					<xsl:element name="bundle_item_type_rd">IPCENTREX_SEAT</xsl:element>
			...
			<xsl:element name="CcmFifCreateContactCmd">
				...
				<xsl:element name="CcmFifCreateContactInCont">
					...
					<xsl:element name="contact_type_rd">CREATE_IPCSEAT</xsl:element>
					<xsl:element name="short_description">IP-Centrex-Seat erstellt</xsl:element>
					<xsl:element name="description_text_list">
						<xsl:element name="CcmFifPassingValueCont">
							<xsl:element name="contact_text">
								<xsl:text>IP-Centrex-Seat-Vertrag (</xsl:text>
