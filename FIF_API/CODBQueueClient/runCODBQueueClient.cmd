...
REM
REM History:
REM $Log:   //PVCS_FIF/archives/FIF_API/CODBQueueClient/runCODBQueueClient.cmd-arc  $
REM   
REM      Rev 1.2   Jun 18 2010 17:19:52   schwarje
...
%JAVA_HOME%\bin\java -Dfif.propertyfile=%~dp0etc\CODBQueueClient.properties -cp %CP% net.arcor.fif.client.SynchronousFIFQueueClient %*
endlocal
