@echo off
REM ---------------------------------------------------------------------------
REM NT script for launching the CaSiO Interfaces-KBA database client
REM
REM $Author:   goethalo  $
REM $Revision:   1.4  $
REM
REM History:
REM $Log:   F:/GRUPPEN/PROJEKTE/PVCS_FIF/archives/FIF/CaSiOInterfacesKBADatabaseClient/runCaSiOInterfacesKBADatabaseClient.cmd-arc  $
REM  
REM     Rev 1.4   Aug 02 2004 15:28:42   goethalo
REM  SPN-FIF-000024410: Oracle 9i migration.
REM  
REM     Rev 1.3   Mar 03 2004 16:28:56   goethalo
...
%JAVA_HOME%\bin\java -Dfif.propertyfile=%~dp0etc\CaSiOInterfacesKBADatabaseClient.properties -cp %CP% net.arcor.fif.client.DatabaseClient %*
endlocal
