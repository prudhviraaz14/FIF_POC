@echo off
REM ---------------------------------------------------------------------------
REM NT script for launching the FIFServiceBusResponseClient
REM
REM $Author:   schwarje  $
REM $Revision:   1.0  $
REM
REM History:
REM $Log:   //PVCS_FIF/archives/FIF_API/FIFServiceBusResponseClient/runFIFServiceBusResponseClient.cmd-arc  $
REM   
REM      Rev 1.0   Jul 30 2008 15:09:06   schwarje
...
%JAVA_HOME%\bin\java -Dfif.propertyfile=%~dp0etc\FIFServiceBusResponseClient.properties -cp %CP% net.arcor.fif.client.SynchronousServiceBusClient %*
endlocal
