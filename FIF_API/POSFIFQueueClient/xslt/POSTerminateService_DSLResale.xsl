...
<xsl:element name="CcmFifCommandList">
  ...
  <xsl:element name="action_name">
    <xsl:value-of select="concat($TopAction, '_DSLResale')"/>
  </xsl:element>   
        ...
        <xsl:element name="service_characteristic_list">
          ...
          <xsl:element name="CcmFifConfiguredValueCont">
            ...
            <xsl:element name="configured_value">
              <xsl:if test="request-param[@name='orderVariant'] = ''">              
                <xsl:if test="(request-param[@name='terminationReason'] = 'ZTCOM') or (request-param[@name='terminationReason'] = 'UMZN')">
                  <xsl:text>Kündigung T-Com</xsl:text>
                </xsl:if>
                <xsl:if test="(request-param[@name='terminationReason'] != 'ZTCOM') and (request-param[@name='terminationReason'] != 'UMZN')">
                  <xsl:text>Kündigung Arcor</xsl:text>
                </xsl:if> 
              </xsl:if>  
              <xsl:if test="request-param[@name='orderVariant'] != ''">              
