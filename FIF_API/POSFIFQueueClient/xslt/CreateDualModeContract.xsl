	...
	<xsl:template match="request-params">
		...
		<xsl:element name="CcmFifAddServiceSubsCmd">
			...
			<xsl:element name="CcmFifAddServiceSubsInCont">
				...
				<xsl:element name="reason_rd">CREATE_DUALMODE</xsl:element>        
				<xsl:if test="request-param[@name='accountNumber'] != ''">	
				...
				<xsl:element name="service_characteristic_list">
					...
					<xsl:element name="CcmFifAccessNumberCont">
						...
						<xsl:element name="storage_masking_digits_rd">1</xsl:element>
		...
		<!-- Add Dual ModeFeature  Service V5002 if requested  -->
		<xsl:if test="request-param[@name='addPortingService'] = 'Y'">
			<xsl:element name="CcmFifAddServiceSubsCmd">
		...
		<xsl:if test="request-param[@name='requestListId'] != ''">
			<xsl:element name="CcmFifCreateExternalNotificationCmd">
				...
				<xsl:element name="CcmFifCreateExternalNotificationInCont">
					...
					<xsl:element name="parameter_value_list">
						<xsl:element name="CcmFifParameterValueCont">
							<xsl:element name="parameter_name">MOFU_SERVICE_SUBSCRIPTION_ID</xsl:element>
							<xsl:element name="parameter_value_ref">
								<xsl:element name="command_id">add_service_1</xsl:element>
								<xsl:element name="field_name">service_subscription_id</xsl:element>
							</xsl:element>
