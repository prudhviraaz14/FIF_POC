#!/usr/bin/sh
# ---------------------------------------------------------------------------
# Shell script for launching the POS-FIF queue client
#
# $Author:   schwarje  $
# $Revision:   1.3  $
# 
# History:
# $Log:   //PVCS_FIF/archives/FIF_API/POSFIFQueueClient/runPOSFIFQueueClient.sh-arc  $
# 
#    Rev 1.3   Jun 18 2010 17:20:10   schwarje
# changes for CPCOM Phase 2: new FIF client type accepting SOM orders
# 
#    Rev 1.2   Jun 01 2010 18:27:56   schwarje
# IT-26029: updates
# 
#    Rev 1.1   Jul 30 2007 15:32:40   schwarje
# IT-19536: added new library to classpath
# 
#    Rev 1.0   Jan 20 2006 12:22:22   banania
# Initial revision.
# 
# 
# ---------------------------------------------------------------------------
...
$JAVA_HOME/bin/java -Dfif.propertyfile=$PWD/etc/POSFIFQueueClient.properties -cp $CPATH net.arcor.fif.client.SynchronousFIFQueueClient
