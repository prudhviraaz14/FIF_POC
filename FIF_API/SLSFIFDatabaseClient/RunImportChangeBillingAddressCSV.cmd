...
REM
REM History: $
REM $Log:   //PVCS_FIF/archives/FIF_API/SLSFIFDatabaseClient/RunImportChangeBillingAddressCSV.cmd-arc  $
REM   
REM      Rev 1.0   Nov 18 2009 17:18:40   banania
...
%JAVA_HOME%\bin\java -Dfif.appname=importChangeBillingAddressCSV.cmd -Dfif.propertyfile=%~dp0etc\ImportChangeBillingAddress.properties -Dfif.clientpropertyfile=%~dp0etc\SLSFIFDatabaseClient.properties -cp %CP% net.arcor.fif.apps.ImportCSVToDB %*
endlocal
