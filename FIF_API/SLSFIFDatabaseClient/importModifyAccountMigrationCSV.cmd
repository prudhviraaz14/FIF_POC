@echo off
REM ---------------------------------------------------------------------------
REM NT script for launching the ImportModifyAccountMigrationCSV application
REM
REM $Author:   wlazlow  $
REM $Revision:   1.0  $
REM
REM History:
REM $Log:   //PVCS_FIF/archives/FIF_API/SLSFIFDatabaseClient/importModifyAccountMigrationCSV.cmd-arc  $
REM   
REM      Rev 1.0   Mar 08 2013 12:39:40   wlazlow
...
%JAVA_HOME%\bin\java -Dfif.appname=importModifyAccountMigrationCSV.cmd -Dfif.propertyfile=%~dp0etc\ImportModifyAccountMigrationCSV.properties -Dfif.clientpropertyfile=%~dp0etc\SLSFIFDatabaseClient.properties -cp %CP% net.arcor.fif.apps.ImportCSVToDB %*
endlocal
