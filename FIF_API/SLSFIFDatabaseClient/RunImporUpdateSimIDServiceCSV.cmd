...
REM
REM History: $
REM $Log:   //PVCS_FIF/archives/FIF_API/SLSFIFDatabaseClient/RunImporUpdateSimIDServiceCSV.cmd-arc  $
REM   
REM      Rev 1.0   Aug 28 2009 17:21:24   banania
...
%JAVA_HOME%\bin\java -Dfif.appname=importUpdateSimIDServiceCSV.cmd -Dfif.propertyfile=%~dp0etc\ImportUpdateSimIDService.properties -Dfif.clientpropertyfile=%~dp0etc\SLSFIFDatabaseClient.properties -cp %CP% net.arcor.fif.apps.ImportCSVToDB %*
endlocal
