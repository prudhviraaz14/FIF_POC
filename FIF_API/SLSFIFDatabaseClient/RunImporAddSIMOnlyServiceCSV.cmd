...
REM
REM History:
REM $Log:   //PVCS_FIF/archives/FIF_API/SLSFIFDatabaseClient/RunImporAddSIMOnlyServiceCSV.cmd-arc  $
REM   
REM      Rev 1.0   Aug 28 2009 16:19:24   banania
...
%JAVA_HOME%\bin\java -Dfif.appname=importAddSIMOnlyServiceCSV.cmd -Dfif.propertyfile=%~dp0etc\ImportAddSIMOnlyService.properties -Dfif.clientpropertyfile=%~dp0etc\SLSFIFDatabaseClient.properties -cp %CP% net.arcor.fif.apps.ImportCSVToDB %*
endlocal
