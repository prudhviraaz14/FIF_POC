@echo off
REM ---------------------------------------------------------------------------
REM NT script for launching the ImportIT21313OrderSimCardCSV application
REM
REM $Author:   schwarje  $
REM $Revision:   1.0  $
REM
REM History:
REM $Log:   //PVCS_FIF/archives/FIF_API/SLSFIFDatabaseClient/importIT21313OrderSimCardCSV.cmd-arc  $
REM   
REM      Rev 1.0   Mar 20 2008 15:42:52   schwarje
...
%JAVA_HOME%\bin\java -Dfif.appname=importIT21313OrderSimCardCSV.cmd -Dfif.propertyfile=%~dp0etc\ImportIT21313OrderSimCardCSV.properties -Dfif.clientpropertyfile=%~dp0etc\SLSFIFDatabaseClient.properties -cp %CP% net.arcor.fif.apps.ImportCSVToDB %*
endlocal
