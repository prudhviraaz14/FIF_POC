...
REM
REM History:
REM $Log:   //PVCS_FIF/archives/FIF_API/SLSFIFDatabaseClient/importReleaseCustomerOrderCSV.cmd-arc  $
REM   
REM      Rev 1.0   Nov 17 2011 13:09:56   wlazlow
...
%JAVA_HOME%\bin\java -Dfif.appname=importReleaseCustomerOrderCSV.cmd -Dfif.propertyfile=%~dp0etc\ImportReleaseCustomerOrderCSV.properties -Dfif.clientpropertyfile=%~dp0etc\SLSFIFDatabaseClient.properties -cp %CP% net.arcor.fif.apps.ImportCSVToDB %*
endlocal
