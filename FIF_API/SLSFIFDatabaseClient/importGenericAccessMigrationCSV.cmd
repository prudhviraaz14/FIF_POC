...
REM
REM History:
REM $Log:   //PVCS_FIF/archives/FIF_API/SLSFIFDatabaseClient/importGenericAccessMigrationCSV.cmd-arc  $
REM   
REM      Rev 1.0   Jul 22 2016 08:38:20   schwarje
...
%JAVA_HOME%\bin\java -Dfif.appname=importGenericAccessMigrationCSV.cmd -Dfif.propertyfile=%~dp0etc\ImportGenericAccessMigrationCSV.properties -Dfif.clientpropertyfile=%~dp0etc\SLSFIFDatabaseClient.properties -cp %CP% net.arcor.fif.apps.ImportSOMOrdersToDB %*
endlocal
