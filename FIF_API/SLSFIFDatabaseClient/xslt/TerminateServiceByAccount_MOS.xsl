...
<xsl:element name="CcmFifFindServiceSubsCmd">
	<xsl:element name="command_id">find_service_mos_1</xsl:element>
...
<xsl:element name="CcmFifCancelNonCompleteStpForProductCmd">
	<xsl:element name="command_id">find_cancel_stp_mos_1</xsl:element>
...
<xsl:element name="CcmFifTerminateOrderFormCmd">
	<xsl:element name="command_id">terminate_of_mos_1</xsl:element>
...
<xsl:element name="CcmFifReconfigServiceCmd">
	<xsl:element name="command_id">reconf_serv_mos_1</xsl:element>
...
<xsl:element name="CcmFifTerminateProductSubsCmd">
	<xsl:element name="command_id">terminate_ps_mos_1</xsl:element>
...
<xsl:element name="CcmFifCreateCustOrderCmd">
	<xsl:element name="command_id">create_co_reconf_mos_1</xsl:element>
	<xsl:element name="CcmFifCreateCustOrderInCont">
		...
		<xsl:element name="provider_tracking_no">001s</xsl:element>
...
<xsl:element name="CcmFifCreateCustOrderCmd">
	<xsl:element name="command_id">create_co_term_mos_1</xsl:element>
	<xsl:element name="CcmFifCreateCustOrderInCont">
		<xsl:element name="customer_number_ref">
			<xsl:element name="command_id">find_service_mos_1</xsl:element>
			<xsl:element name="field_name">customer_number</xsl:element>
		...
		<xsl:element name="provider_tracking_no">002s</xsl:element>
		<xsl:element name="service_ticket_pos_list">
			<xsl:element name="CcmFifCommandRefCont">
				<xsl:element name="command_id">terminate_ps_mos_1</xsl:element>
