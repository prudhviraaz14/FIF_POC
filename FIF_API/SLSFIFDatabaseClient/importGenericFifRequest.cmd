@echo off
REM ---------------------------------------------------------------------------
REM NT script for launching the ImportMigrateMOSCSV application
REM
REM $Author:   schwarje  $
REM $Revision:   1.0  $
REM
REM History:
REM $Log:   //PVCS_FIF/archives/FIF_API/SLSFIFDatabaseClient/importGenericFifRequest.cmd-arc  $
REM   
REM      Rev 1.0   Apr 20 2012 08:07:28   schwarje
REM   Initial revision.
REM   
REM      Rev 1.0   Feb 03 2011 14:36:48   schwarje
REM   Initial revision.
REM 
REM ---------------------------------------------------------------------------
...
%JAVA_HOME%\bin\java -Dfif.appname=importGenericFifRequest.cmd -Dfif.propertyfile=%~dp0etc\ImportGenericFifRequest.properties -Dfif.clientpropertyfile=%~dp0etc\SLSFIFDatabaseClient.properties -cp %CP% net.arcor.fif.apps.ImportCSVToDB %*
endlocal
