...
REM
REM History:
REM $Log:   //PVCS_FIF/archives/FIF_API/SLSFIFDatabaseClient/importMigrateBitstreamVDSLL2CSV.cmd-arc  $
REM   
REM      Rev 1.0   Dec 21 2015 11:13:48   schwarje
...
%JAVA_HOME%\bin\java -Dfif.appname=importMigrateBitstreamVDSLL2CSV.cmd -Dfif.propertyfile=%~dp0etc\ImportMigrateBitstreamVDSLL2CSV.properties -Dfif.clientpropertyfile=%~dp0etc\SLSFIFDatabaseClient.properties -cp %CP% net.arcor.fif.apps.ImportSOMOrdersToDB %*
endlocal
