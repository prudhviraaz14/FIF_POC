...
REM
REM History:
REM $Log:   //PVCS_FIF/archives/FIF_API/SLSFIFDatabaseClient/importMigrateMOSCSV.cmd-arc  $
REM   
...
%JAVA_HOME%\bin\java -Dfif.appname=importMigrateMOSCSV.cmd -Dfif.propertyfile=%~dp0etc\ImportMigrateMOSCSV.properties -Dfif.clientpropertyfile=%~dp0etc\SLSFIFDatabaseClient.properties -cp %CP% net.arcor.fif.apps.ImportCSVToDB %*
endlocal
