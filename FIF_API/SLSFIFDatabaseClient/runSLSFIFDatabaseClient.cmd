...
REM
REM History:
REM $Log:   //PVCS_FIF/archives/FIF_API/SLSFIFDatabaseClient/runSLSFIFDatabaseClient.cmd-arc  $
REM  
REM     Rev 1.6   Jun 01 2010 18:28:12   schwarje
REM  IT-26029: updates
REM  
REM     Rev 1.5   Jul 30 2007 15:34:12   schwarje
REM  IT-19536: added new library to classpath
REM  
REM     Rev 1.4   Aug 02 2004 15:29:58   goethalo
REM  SPN-FIF-000024410: Oracle 9i migration.
REM  
REM     Rev 1.3   Mar 03 2004 16:31:06   goethalo
...
%JAVA_HOME%\bin\java -Dfif.propertyfile=%~dp0etc\SLSFIFDatabaseClient.properties -cp %CP% net.arcor.fif.client.SynchronousDatabaseClient %*
endlocal
