...
REM
REM History:
REM $Log:   //PVCS_FIF/archives/FIF_API/SLSFIFDatabaseClient/importSLTAddHardwareServiceCSV.cmd-arc  $
REM   
REM      Rev 1.0   Sep 06 2006 18:33:14   wlazlow
...
%JAVA_HOME%\bin\java -Dfif.appname=importSLSAddHardwareServiceCSV.cmd -Dfif.propertyfile=%~dp0etc\ImportSLSAddHardwareServiceCSV.properties -Dfif.clientpropertyfile=%~dp0etc\SLSFIFDatabaseClient.properties -cp %CP% net.arcor.fif.apps.ImportCSVToDB %*
endlocal
