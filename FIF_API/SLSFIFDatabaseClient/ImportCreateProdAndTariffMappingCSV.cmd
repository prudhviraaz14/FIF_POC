...
REM
REM History:
REM $Log:   //PVCS_FIF/archives/FIF_API/SLSFIFDatabaseClient/ImportCreateProdAndTariffMappingCSV.cmd-arc  $
REM   
...
%JAVA_HOME%\bin\java -Dfif.appname=importAccessNumberPortingCSV.cmd -Dfif.propertyfile=%~dp0etc\ImportCreateProdAndTariffMapping.properties -Dfif.clientpropertyfile=%~dp0etc\SLSFIFDatabaseClient.properties -cp %CP% net.arcor.fif.apps.ImportCSVToDB %*
endlocal
