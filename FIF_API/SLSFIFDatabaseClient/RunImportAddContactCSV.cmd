...
REM
REM History: $
REM $Log:   //PVCS_FIF/archives/FIF_API/SLSFIFDatabaseClient/RunImportAddContactCSV.cmd-arc  $
REM   
REM      Rev 1.0   Nov 09 2009 17:37:02   banania
...
%JAVA_HOME%\bin\java -Dfif.appname=importAddContactCSV.cmd -Dfif.propertyfile=%~dp0etc\ImportAddContact.properties -Dfif.clientpropertyfile=%~dp0etc\SLSFIFDatabaseClient.properties -cp %CP% net.arcor.fif.apps.ImportCSVToDB %*
endlocal
