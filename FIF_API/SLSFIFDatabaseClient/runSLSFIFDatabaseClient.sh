#!/usr/bin/sh
# ---------------------------------------------------------------------------
# Shell script for launching the SLS-FIF database client
#
# $Author:   schwarje  $
# $Revision:   1.5  $
# 
# History:
# $Log:   //PVCS_FIF/archives/FIF_API/SLSFIFDatabaseClient/runSLSFIFDatabaseClient.sh-arc  $
# 
#    Rev 1.5   Jun 01 2010 18:28:12   schwarje
# IT-26029: updates
# 
#    Rev 1.4   Jul 30 2007 15:34:12   schwarje
# IT-19536: added new library to classpath
# 
#    Rev 1.3   Aug 02 2004 15:29:58   goethalo
# SPN-FIF-000024410: Oracle 9i migration.
# 
#    Rev 1.2   Mar 02 2004 11:19:40   goethalo
...
$JAVA_HOME/bin/java -Dfif.propertyfile=$PWD/etc/SLSFIFDatabaseClient.properties -cp $CPATH net.arcor.fif.client.SynchronousDatabaseClient
