@echo off
REM ---------------------------------------------------------------------------
REM NT script for launching the ImportChangeCustomerCSV application
REM
REM $Author:   goethalo  $
REM $Revision:   1.1  $
REM
REM History:
REM $Log:   F:/GRUPPEN/PROJEKTE/PVCS_FIF/archives/FIF/SLSFIFDatabaseClient/importChangeCustomerCSV.cmd-arc  $
REM   
REM      Rev 1.1   Aug 02 2004 15:29:54   goethalo
REM   SPN-FIF-000024410: Oracle 9i migration.
REM   
REM      Rev 1.0   May 18 2004 13:11:02   schwarje
...
%JAVA_HOME%\bin\java -Dfif.appname=importChangeCustomerCSV.cmd -Dfif.propertyfile=%~dp0etc\ImportChangeCustomerCSV.properties -Dfif.clientpropertyfile=%~dp0etc\SLSFIFDatabaseClient.properties -cp %CP% net.arcor.fif.apps.ImportCSVToDB %*
endlocal
