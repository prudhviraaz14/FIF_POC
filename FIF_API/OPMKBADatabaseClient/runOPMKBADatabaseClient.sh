#!/usr/bin/sh
# ---------------------------------------------------------------------------
# Shell script for launching the OPM-KBA database client
#
# $Author:   goethalo  $
# $Revision:   1.3  $
# 
# History:
# $Log:   F:/GRUPPEN/PROJEKTE/PVCS_FIF/archives/FIF/OPMKBADatabaseClient/runOPMKBADatabaseClient.sh-arc  $
# 
#    Rev 1.3   Aug 02 2004 15:29:46   goethalo
# SPN-FIF-000024410: Oracle 9i migration.
# 
#    Rev 1.2   Mar 02 2004 11:19:24   goethalo
...
$JAVA_HOME/bin/java -Dfif.propertyfile=$PWD/etc/OPMKBADatabaseClient.properties -cp $CPATH net.arcor.fif.client.DatabaseClient
