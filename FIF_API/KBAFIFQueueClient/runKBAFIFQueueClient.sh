...
# 
# History:
# $Log:   //PVCS_FIF/archives/FIF_API/KBAFIFQueueClient/runKBAFIFQueueClient.sh-arc  $
# 
#    Rev 1.6   Jun 18 2010 17:19:26   schwarje
# changes for CPCOM Phase 2: new FIF client type accepting SOM orders
# 
#    Rev 1.5   Jun 01 2010 18:27:32   schwarje
# IT-26029: updates
# 
...
$JAVA_HOME/bin/java -Dfif.propertyfile=$PWD/etc/KBAFIFQueueClient.properties -cp $CPATH net.arcor.fif.client.SynchronousFIFQueueClient
