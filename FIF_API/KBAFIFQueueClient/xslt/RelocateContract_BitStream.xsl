    ...
    <!-- add the new Bit DSL  bundle item if a bundle is found -->
    ...
    <!-- add the new Bit VoIP  bundle item if a bundle is found -->
    <xsl:element name="CcmFifModifyBundleItemCmd">
    ...
    <!-- Create Customer Orders for Cloning Bit-DSL -->
    ...
    <!-- Create Customer Orders for Cloning Bit-VoIP -->
    <xsl:element name="CcmFifCreateCustOrderCmd">
