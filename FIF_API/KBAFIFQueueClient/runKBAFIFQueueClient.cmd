...
REM
REM History:
REM $Log:   //PVCS_FIF/archives/FIF_API/KBAFIFQueueClient/runKBAFIFQueueClient.cmd-arc  $
REM  
REM     Rev 1.7   Jun 18 2010 17:19:26   schwarje
REM  changes for CPCOM Phase 2: new FIF client type accepting SOM orders
REM  
REM     Rev 1.6   Jun 01 2010 18:27:32   schwarje
...
%JAVA_HOME%\bin\java -Dfif.propertyfile=%~dp0etc\KBAFIFQueueClient.properties -cp %CP% net.arcor.fif.client.SynchronousFIFQueueClient %*
endlocal
