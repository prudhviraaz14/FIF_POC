            ...
            <xsl:if test="request-param[@name='serviceSubscriptionId'] = ''">
              <xsl:element name="CcmFifRaiseErrorCmd">
                ...
                <xsl:element name="CcmFifRaiseErrorInCont">
                  <xsl:element name="error_text">serviceSubscriptionId has to be provided for the termination.</xsl:element>
                </xsl:element>
              </xsl:element>
          </xsl:if>
              ...
              <xsl:element name="CcmFifCreateCustOrderInCont">
                ...
                <xsl:element name="provider_tracking_no">
                  <xsl:choose>
                    ...
                    <xsl:otherwise>001b</xsl:otherwise>
                  </xsl:choose>
                </xsl:element>			  	
              ...
              <xsl:element name="CcmFifCreateCustOrderInCont">
                ...
                <xsl:element name="provider_tracking_no">
                  <xsl:choose>
                    ...
                    <xsl:otherwise>002b</xsl:otherwise>
                  </xsl:choose>
                </xsl:element>			  	
                <xsl:element name="service_ticket_pos_list">
                  <xsl:element name="CcmFifCommandRefCont">
