...
<!--
	XSLT file for creating a PCBackup contract
		...
		<xsl:element name="Command_List">
			...
			<xsl:if test="request-param[@name='customerNumber'] != ''">
				<xsl:element name="CcmFifFindServiceSubsCmd">
					<xsl:element name="command_id">find_existing_backup_service</xsl:element>
				...
				<xsl:element name="CcmFifRaiseErrorCmd">
					...
					<xsl:element name="CcmFifRaiseErrorInCont">
						<xsl:element name="error_text">BuR_Nachbestellung</xsl:element>
			...
			<xsl:if test="request-param[@name='productCommitmentNumber'] = ''">
				...
				<xsl:element name="CcmFifAddProductCommitCmd">
					...
					<xsl:element name="CcmFifAddProductCommitInCont">
						...
						<xsl:element name="product_code">I4000</xsl:element>
			...
			<xsl:element name="CcmFifAddServiceSubsCmd">
				...
				<xsl:element name="CcmFifAddServiceSubsInCont">
					...
					<xsl:element name="reason_rd">CREATE_BACKUP</xsl:element>
					<xsl:if test="$accountNumber = ''">
			...
			<xsl:element name="CcmFifFindServiceSubsCmd">
				<xsl:element name="command_id">find_backup_service</xsl:element>
				<xsl:element name="CcmFifFindServiceSubsInCont">
					<xsl:if test="request-param[@name='customerNumber'] = ''">
						<xsl:element name="customer_number_ref">
							<xsl:element name="command_id">read_customer_number</xsl:element>
			...
			<xsl:if test="request-param[@name='featureServiceCode'] = 'I4011'">
			...
			<!-- Add feature -->
			<xsl:element name="CcmFifAddServiceSubsCmd">
				<xsl:element name="command_id">add_feature_service</xsl:element>
				<xsl:element name="CcmFifAddServiceSubsInCont">
					<xsl:element name="product_subscription_ref">
						<xsl:element name="command_id">find_backup_service</xsl:element>
						<xsl:element name="field_name">product_subscription_id</xsl:element>
			...
			<!-- add storage upgrade, if applicable -->
			<xsl:if test="request-param[@name='storageUpgrade'] != ''">
				<xsl:element name="CcmFifAddServiceSubsCmd">
					<xsl:element name="command_id">add_storage_service</xsl:element>
					<xsl:element name="CcmFifAddServiceSubsInCont">
						<xsl:element name="product_subscription_ref">
							<xsl:element name="command_id">find_backup_service</xsl:element>
							<xsl:element name="field_name">product_subscription_id</xsl:element>
						</xsl:element>
						<xsl:element name="service_code">I4012</xsl:element>
						<xsl:element name="parent_service_subs_ref">
							<xsl:element name="command_id">add_feature_service</xsl:element>
							<xsl:element name="field_name">service_subscription_id</xsl:element>
						</xsl:element>
						...
						<xsl:element name="service_characteristic_list">
							...
							<xsl:element name="CcmFifConfiguredValueCont">
								...
								<xsl:element name="data_type">INTEGER</xsl:element>
								<xsl:element name="configured_value">
									<xsl:value-of select="request-param[@name='storageUpgrade']"/>
								</xsl:element>
							</xsl:element>						
						</xsl:element>
					</xsl:element>
			...
			<xsl:element name="CcmFifCreateContactCmd">
				...
				<xsl:element name="CcmFifCreateContactInCont">
					...
					<xsl:element name="contact_type_rd">CREATE_BACKUP</xsl:element>
					<xsl:element name="short_description">
						<xsl:text>PC-Backup bestellt</xsl:text>
					</xsl:element>
					<xsl:element name="description_text_list">
						<xsl:element name="CcmFifPassingValueCont">
							<xsl:element name="contact_text">
								<xsl:text>PC-Backup bestellt.&#xA;Vertragsnummer: </xsl:text>
							</xsl:element>
						</xsl:element>
						<xsl:element name="CcmFifCommandRefCont">
							<xsl:element name="command_id">find_backup_service</xsl:element>
					...
					<xsl:element name="CcmFifCreateExternalNotificationInCont">
						...
						<xsl:element name="parameter_value_list">
							<xsl:element name="CcmFifParameterValueCont">
								<xsl:element name="parameter_name">BACKUP_SERVICE_SUBSCRIPTION_ID</xsl:element>
