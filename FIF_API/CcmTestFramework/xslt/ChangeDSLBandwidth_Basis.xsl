...
-->
    ...
    <xsl:element name="action_name">
      <xsl:value-of select="concat($TopAction, '_basis')"/>
    </xsl:element>
    ...
    <xsl:element name="Command_List">
      ...
      <!-- Reconfigure the main access service ASAP, if there is no relocation or DSL upgrade customer order -->
      ...
      <!-- Find the DSL bandwidth service-->
      <xsl:element name="CcmFifFindExclusiveChildServSubsCmd">
