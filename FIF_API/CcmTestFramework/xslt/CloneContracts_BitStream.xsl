    ...
    <xsl:element name="CcmFifCloneOrderFormCmd">
      ...
      <xsl:element name="CcmFifCloneOrderFormInCont">
        ...
        <xsl:choose>
          <xsl:when test="$targetAccountNumber != ''">
        ...
        <xsl:element name="service_characteristic_list">
          ...
          <xsl:element name="CcmFifConfiguredValueCont">
            ...
            <xsl:element name="configured_value">
              <xsl:choose>
                <xsl:when test="request-param[@name='DSLBandwidth'] = 'DSL 768'">DSL 1000</xsl:when>
                <xsl:when test="request-param[@name='DSLBandwidth'] = 'DSL 1500'">DSL 2000</xsl:when>
                <xsl:when test="request-param[@name='DSLBandwidth'] = 'DSL 3000'">DSL 6000</xsl:when>
                <xsl:otherwise>
          ...
          <!-- Einwilligung zum Bandbreitenwechsel -->
          <xsl:element name="CcmFifConfiguredValueCont">
    ...
    <!-- if the bandwidth is not provided, this must be a contract partner change 
      ...
      <xsl:variable name="bandwidthServiceCode">
        <xsl:choose>
          <xsl:when test="request-param[@name='DSLBandwidth'] = 'DSL 768'">V0116</xsl:when>
