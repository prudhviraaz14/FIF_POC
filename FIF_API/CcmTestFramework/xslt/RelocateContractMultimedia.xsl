...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="request-params">
    ...
    <xsl:element name="Command_List">
      ...
      <xsl:variable name="OrderVariant">Umzug</xsl:variable>              
      ...
      <!-- Look for the NGNDSL service in the external notification if order to validate the characteristic I1323 -->      
      ...
      <xsl:element name="CcmFifFindServiceCharByValueCmd">
        ...
        <xsl:element name="CcmFifFindServiceCharByValueInCont">
          ...
          <xsl:if test="request-param[@name='productCode'] = 'I1302'
            ...
            <xsl:element name="characteristic_value">IPTV_BASIC</xsl:element>
          </xsl:if>
          <xsl:if test="request-param[@name='productCode'] = 'I1304'
            and request-param[@name='targetProductCode'] = ''">
            <xsl:element name="characteristic_value">VOD_BASIC</xsl:element>
          </xsl:if>
        ...
        <xsl:element name="CcmFifCloneOrderFormInCont">
          ...
          <xsl:element name="service_characteristic_list">
            ...
            <xsl:element name="CcmFifConfiguredValueCont">
              ...
              <xsl:element name="data_type">STRING</xsl:element>
              <xsl:element name="configured_value">Umzug Multimedia-Vertrag</xsl:element>
            </xsl:element>                   
          </xsl:element>
        ...
        <xsl:element name="CcmFifCreateExternalNotificationInCont">
          ...
          <xsl:element name="parameter_value_list">
            <xsl:element name="CcmFifParameterValueCont">
              <xsl:if test="(request-param[@name='productCode'] = 'I1302'
                and request-param[@name='targetProductCode'] = '')
                or (request-param[@name='targetProductCode'] = 'I1302')">
                <xsl:element name="parameter_name">IPTV_SERVICE_SUBSCRIPTION_ID</xsl:element>
              </xsl:if>
              <xsl:if test="(request-param[@name='productCode'] = 'I1304'
                and request-param[@name='targetProductCode'] = '')
                or (request-param[@name='targetProductCode'] = 'I1304')">
