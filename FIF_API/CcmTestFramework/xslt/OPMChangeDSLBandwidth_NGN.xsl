  ...
  <xsl:element name="Command_List">
      ...
      <xsl:if test="(request-param[@name='SPECIAL_TERM_RIGHT'] != '')
        ...
        <xsl:if test="(request-param[@name='SPECIAL_TERM_RIGHT'] != 'NONE')
         ...
         <!-- Reconfigure the main access service for NGN-->
       <!-- added process_ind_ref and required_process_ind to execute only if  NGN-->
<!--       <xsl:if test="((request-param[@name='NEW_DSL_BANDWIDTH'] = 'DSL 1000') or
       ...
       <xsl:element name="CcmFifReconfigServiceCmd">
        <xsl:element name="command_id">reconf_ngn_serv_1</xsl:element>
      ...
      <xsl:element name="CcmFifTerminateChildServiceSubsCmd">
        <xsl:element name="command_id">term_ngn_ss_1</xsl:element>
      ...
      <xsl:element name="CcmFifAddServiceSubsCmd">
        <xsl:element name="command_id">add_ngn_service_1</xsl:element>
      ...
      <!-- Create Customer Order for Termination for  NGN -->
      <xsl:element name="CcmFifCreateCustOrderCmd">
        <xsl:element name="command_id">create_ngn_co_1</xsl:element>
      ...
      <!-- Create Customer Order for new services   for NGN -->
<!--      <xsl:if test="((request-param[@name='NEW_DSL_BANDWIDTH'] = 'DSL 1000') or
          (request-param[@name='NEW_DSL_BANDWIDTH'] = 'DSL 2000') or
          (request-param[@name='NEW_DSL_BANDWIDTH'] = 'DSL 6000') or
          (request-param[@name='NEW_DSL_BANDWIDTH'] = 'DSL 16000'))">     -->
      <xsl:element name="CcmFifCreateCustOrderCmd">
        <xsl:element name="command_id">create_ngn_co_2</xsl:element>
        <xsl:element name="CcmFifCreateCustOrderInCont">
          <xsl:element name="customer_number_ref">
            <xsl:element name="command_id">find_service_1</xsl:element>
            <xsl:element name="field_name">customer_number</xsl:element>
    ...
    <!-- Release Customer Order for new services in case of NGN -->
    <xsl:element name="CcmFifReleaseCustOrderCmd">
      <xsl:element name="command_id">release_ngn_co_1</xsl:element>
      ...
      <!-- Release Customer Order for new services in case of NGN -->
      <xsl:element name="CcmFifReleaseCustOrderCmd">
        <xsl:element name="command_id">release_ngn_co_2</xsl:element>
        <xsl:element name="CcmFifReleaseCustOrderInCont">
          <xsl:element name="customer_number_ref">
            <xsl:element name="command_id">find_service_1</xsl:element>
            <xsl:element name="field_name">customer_number</xsl:element>
