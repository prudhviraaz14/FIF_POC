    ...
    <xsl:element name="Command_List">
      ...
      <xsl:if test="(($Type != '')
        ...
        <xsl:element name="CcmFifRaiseErrorCmd">
          ...
          <xsl:element name="CcmFifRaiseErrorInCont">
            <xsl:element name="error_text">The parameter type has to  be set to VoIP or NGNVoIP!</xsl:element>
          </xsl:element>
        </xsl:element>
      </xsl:if>
      ...
      <xsl:if test="(request-param[@name='accessNumber'] != '') or
        ...
        <xsl:element name="CcmFifFindServiceSubsCmd">
          ...
          <xsl:element name="CcmFifFindServiceSubsInCont">
            ...
            <xsl:if test="(request-param[@name='accessNumber'] != '') and (request-param[@name='productSubscriptionId'] = '')">            
