...
<xsl:stylesheet exclude-result-prefixes="dateutils" version="1.0"
	...
	<xsl:template match="request-params">
		...
		<xsl:element name="Command_List">
			...
			<!-- Create OneGroup -->
			<xsl:element name="CcmFifCreateOneGroupCmd">
				<xsl:element name="command_id">create_one_group</xsl:element>
				<xsl:element name="CcmFifCreateOneGroupInCont">
					...
					<xsl:element name="parameter_value_list">
						<xsl:element name="CcmFifParameterValueCont">
							...
							<xsl:element name="parameter_value_ref">
								<xsl:element name="command_id">create_one_group</xsl:element>
								<xsl:element name="field_name">one_group_id</xsl:element>
							</xsl:element>
						</xsl:element>	
					</xsl:element>          
				</xsl:element>
