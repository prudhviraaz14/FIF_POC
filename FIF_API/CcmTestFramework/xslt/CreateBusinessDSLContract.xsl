...
<!--
  XSLT file for creating a SDSL contract
...
<xsl:stylesheet exclude-result-prefixes="dateutils" version="1.0"
	...
	<xsl:template match="request-params">
		...
		<xsl:element name="Command_List">
			...
			<xsl:variable name="productCode">I1207</xsl:variable>
			...
			<xsl:variable name="mainAccessServiceCode">
				<xsl:choose>
					<xsl:when test="request-param[@name='businessDslType'] = 'SDSL'">I1215</xsl:when>
					<xsl:when test="request-param[@name='businessDslType'] = 'ADSL'">I1216</xsl:when>
			...
			<xsl:element name="CcmFifAddServiceSubsCmd">
				<xsl:element name="command_id">add_bandwidth</xsl:element>
				<xsl:element name="CcmFifAddServiceSubsInCont">
					<xsl:element name="product_subscription_ref">
						<xsl:element name="command_id">add_product_subscription</xsl:element>
						<xsl:element name="field_name">product_subscription_id</xsl:element>
			...
			<!-- add the new  bundle item of type SDSLACCESS -->
			<xsl:element name="CcmFifModifyBundleItemCmd">
				...
				<xsl:element name="CcmFifModifyBundleItemInCont">
					...
					<xsl:element name="bundle_item_type_rd">SDSLACCESS</xsl:element>
			...
			<!-- add the new  bundle item of type SDSLONLINE -->
			<xsl:element name="CcmFifModifyBundleItemCmd">
				<xsl:element name="command_id">modify_bundle_item</xsl:element>
				<xsl:element name="CcmFifModifyBundleItemInCont">
					<xsl:element name="bundle_id_ref">
					...
					<xsl:element name="bundle_item_type_rd">SDSLONLINE</xsl:element>
					<xsl:element name="supported_object_id_ref">
						<xsl:element name="command_id">add_main_service</xsl:element>
						<xsl:element name="field_name">service_subscription_id</xsl:element>
					</xsl:element>
			...
			<xsl:element name="CcmFifCreateContactCmd">
				...
				<xsl:element name="CcmFifCreateContactInCont">
					...
					<xsl:element name="contact_type_rd">CREATE_SDSL</xsl:element>
					<xsl:element name="short_description">Business-DSL-Vertrag erstellt</xsl:element>
					<xsl:element name="description_text_list">
						<xsl:element name="CcmFifPassingValueCont">
							<xsl:element name="contact_text">
								<xsl:text>Business-DSL-Vertrag (</xsl:text>
								<xsl:value-of select="request-param[@name='businessDslType']"/>
