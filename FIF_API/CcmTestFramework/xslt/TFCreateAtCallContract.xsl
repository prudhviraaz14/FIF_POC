    ...
    <xsl:element name="Command_List">
      ...
      <xsl:element name="CcmFifAddProductCommitCmd">
        ...
        <xsl:element name="CcmFifAddProductCommitInCont">
          ...
          <xsl:element name="product_code">VI001</xsl:element>
      ...
      <xsl:element name="CcmFifAddServiceSubsCmd">
        <xsl:element name="command_id">add_service_subscription_VI001</xsl:element>
        <xsl:element name="CcmFifAddServiceSubsInCont">
          <xsl:element name="product_subscription_ref">
            <xsl:element name="command_id">add_product_subscription_1</xsl:element>
            <xsl:element name="field_name">product_subscription_id</xsl:element>
          </xsl:element>
          <xsl:element name="service_code">VI001</xsl:element>
