...
<xsl:element name="CcmFifCommandList">
  ...
  <xsl:element name="action_name">
    <xsl:value-of select="concat($TopAction, '_BitStream')"/>
  </xsl:element>
  ...
  <xsl:element name="Command_List">
      ...
      <xsl:if test="(request-param[@name='SPECIAL_TERM_RIGHT'] != '')
        ...
        <!-- get SDCPC  -->
        <xsl:element name="CcmFifGetProductCommitmentDataCmd">
          <xsl:element name="command_id">get_prod_comm_data_2</xsl:element>
          <xsl:element name="CcmFifGetProductCommitmentDataInCont">
            <xsl:element name="product_commitment_number_ref">
              <xsl:element name="command_id">find_service_2</xsl:element>
              <xsl:element name="field_name">product_commitment_number</xsl:element>
        ...
        <!-- Renegotiate SDCPC  -->
        <xsl:element name="CcmFifRenegotiateSDCProductCommitmentCmd">
          <xsl:element name="command_id">renegotiate_sdc_2</xsl:element>
          <xsl:element name="CcmFifRenegotiateSDCProductCommitmentInCont">
            <xsl:element name="product_commitment_number_ref">
              <xsl:element name="command_id">find_service_2</xsl:element>
              <xsl:element name="field_name">product_commitment_number</xsl:element>
        ...
        <!-- Sign Order Form -->
        <xsl:element name="CcmFifSignAndApplyNewPricingStructCmd">
          <xsl:element name="command_id">sign_order_form_2</xsl:element>
          <xsl:element name="CcmFifSignAndApplyNewPricingStructInCont">
            <xsl:element name="supported_object_id_ref">
              <xsl:element name="command_id">find_service_2</xsl:element>
              <xsl:element name="field_name">contract_number</xsl:element>
        ...
        <!-- Sign SDC -->
        <xsl:element name="CcmFifSignAndApplyNewPricingStructCmd">
          <xsl:element name="command_id">sign_sdc_2</xsl:element>
          <xsl:element name="CcmFifSignAndApplyNewPricingStructInCont">
            <xsl:element name="supported_object_id_ref">
              <xsl:element name="command_id">find_service_2</xsl:element>
              <xsl:element name="field_name">product_commitment_number</xsl:element>
    ...
    <!-- Reconfigure the main access service for Bitstream-->
    <xsl:if test="((request-param[@name='NEW_DSL_BANDWIDTH'] = 'DSL 2000') or
          (request-param[@name='NEW_DSL_BANDWIDTH'] = 'DSL 6000') or
          (request-param[@name='NEW_DSL_BANDWIDTH'] = 'DSL 16000') or
          (request-param[@name='NEW_DSL_BANDWIDTH'] = 'DSL 25000') or
          (request-param[@name='NEW_DSL_BANDWIDTH'] = 'DSL 50000'))">
       <xsl:element name="CcmFifReconfigServiceCmd">
        <xsl:element name="command_id">reconf_bit_serv_1</xsl:element>
        <xsl:element name="CcmFifReconfigServiceInCont">
          ...
          <xsl:element name="service_characteristic_list">
           ...
           <!-- V0092 -->
            ...
            <!-- Port Type-->
            <xsl:if test="request-param[@name='PORT_TYPE'] != ''">
              <xsl:element name="CcmFifConfiguredValueCont">
                <xsl:element name="service_char_code">V009C</xsl:element>
                <xsl:element name="data_type">STRING</xsl:element>
                <xsl:element name="configured_value">
                  <xsl:value-of select="request-param[@name='PORT_TYPE']"/>
                </xsl:element>
              </xsl:element>
            </xsl:if>
          </xsl:element>             
      ...
      <!-- Only terminate if the DSL bandwidth is changing  for non ISDN-->
      <xsl:element name="CcmFifTerminateChildServiceSubsCmd">
        <xsl:element name="command_id">term_bit_ss_1</xsl:element>
      ...
      <xsl:element name="CcmFifAddServiceSubsCmd">
        <xsl:element name="command_id">add_bit_service_1</xsl:element>
        <xsl:element name="CcmFifAddServiceSubsInCont">
          ...
          <xsl:if test="request-param[@name='NEW_DSL_BANDWIDTH'] != 'DSL 768'
            ...
            and request-param[@name='NEW_DSL_BANDWIDTH'] != 'DSL 25000'
            and request-param[@name='NEW_DSL_BANDWIDTH'] != 'DSL 50000'">
      ...
      <!-- Create Customer Order for Termination for  bit -->
      <xsl:element name="CcmFifCreateCustOrderCmd">
        <xsl:element name="command_id">create_bit_co_1</xsl:element>
      ...
      <!-- Create Customer Order for new services   for bit -->
<!--      <xsl:if test="((request-param[@name='NEW_DSL_BANDWIDTH'] = 'DSL 1000') or
      ...
      <xsl:element name="CcmFifCreateCustOrderCmd">
        <xsl:element name="command_id">create_bit_co_2</xsl:element>
        <xsl:element name="CcmFifCreateCustOrderInCont">
          <xsl:element name="customer_number_ref">
            <xsl:element name="command_id">find_service_1</xsl:element>
            <xsl:element name="field_name">customer_number</xsl:element>
    ...
    <xsl:element name="CcmFifReleaseCustOrderCmd">
      <xsl:element name="command_id">release_bit_co_1</xsl:element>
      ...
      <!-- Release Customer Order -->
      <xsl:element name="CcmFifReleaseCustOrderCmd">
        <xsl:element name="command_id">release_bit_co_2</xsl:element>
        <xsl:element name="CcmFifReleaseCustOrderInCont">
          <xsl:element name="customer_number_ref">
            <xsl:element name="command_id">find_service_1</xsl:element>
            <xsl:element name="field_name">customer_number</xsl:element>
