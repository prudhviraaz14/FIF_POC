    ...
    <xsl:element name="CcmFifCloneOrderFormCmd">
      ...
      <xsl:element name="CcmFifCloneOrderFormInCont">
        ...
        <xsl:element name="target_product_type">
          <xsl:text>ISDN_</xsl:text>
          <xsl:value-of select="$targetProductType"/>
        </xsl:element>         
        <xsl:element name="service_characteristic_list">
          
          <!-- Use of new address only for relocation and provider change scenarios -->
          <xsl:if test="$scenarioType = 'RELOCATION' or 
            $scenarioType = 'PROVIDER_CHANGE' or 
            $scenarioType = 'TAKEOVER'">
            <!-- Standort-Adresse -->
              ...
              <xsl:otherwise>
                <xsl:choose>
                  ...
                  <xsl:when test="$keepAccessNumbers = 'Y'">
                    <!-- in a non-downgrade scenario, just populate all access numbers, which were provided -->
                    <xsl:for-each select="request-param-list[@name='oldAccessNumberList']/request-param-list-item">              
                      <xsl:variable name="serviceCharCode">
                        <xsl:choose>
                          <xsl:when test="position() = 1">V0001</xsl:when>
    ...
    <xsl:if test="$createDSL = 'Y' and request-param[@name='DSLBandwidth'] = ''">
        ...
        <xsl:element name="CcmFifMapStringInCont">
          ...
          <xsl:element name="string_mapping_list">
            <xsl:element name="CcmFifStringMappingCont">
              <xsl:element name="input_string">DSL 500</xsl:element>
              <xsl:element name="output_string">V0179</xsl:element>
            </xsl:element>
            <xsl:element name="CcmFifStringMappingCont">
              <xsl:element name="input_string">Premium</xsl:element>
              <xsl:element name="output_string">V0116</xsl:element>
            </xsl:element>
            <xsl:element name="CcmFifStringMappingCont">
              <xsl:element name="input_string">Gold</xsl:element>
              <xsl:element name="output_string">V0117</xsl:element>
            </xsl:element>
            <xsl:element name="CcmFifStringMappingCont">
            ...
            <xsl:element name="CcmFifStringMappingCont">
              <xsl:element name="input_string">DSL 3000</xsl:element>
              <xsl:element name="output_string">V0175</xsl:element>
            </xsl:element>
            <xsl:element name="CcmFifStringMappingCont">
              <xsl:element name="input_string">DSL 4000</xsl:element>
              <xsl:element name="output_string">V0176</xsl:element>
            </xsl:element>
            <xsl:element name="CcmFifStringMappingCont">
              <xsl:element name="input_string">DSL 5000</xsl:element>
              <xsl:element name="output_string">V0177</xsl:element>
            </xsl:element>
            <xsl:element name="CcmFifStringMappingCont">
            ...
            <xsl:element name="CcmFifStringMappingCont">
              <xsl:element name="input_string">DSL 8000</xsl:element>
              <xsl:element name="output_string">V0180</xsl:element>
            </xsl:element>
            <xsl:element name="CcmFifStringMappingCont">
              <xsl:element name="input_string">DSL 10000</xsl:element>
              <xsl:element name="output_string">V018A</xsl:element>
            </xsl:element>
            <xsl:element name="CcmFifStringMappingCont">
              <xsl:element name="input_string">DSL 12000</xsl:element>
              <xsl:element name="output_string">V018B</xsl:element>
            </xsl:element>
            <xsl:element name="CcmFifStringMappingCont">
            ...
            <xsl:element name="CcmFifStringMappingCont">
              <xsl:element name="input_string">DSL 20000</xsl:element>
              <xsl:element name="output_string">V018D</xsl:element>
            </xsl:element>
            <xsl:element name="CcmFifStringMappingCont">
      ...
      <xsl:element name="CcmFifFindServCharValueForServCharCmd">
        <xsl:element name="command_id">find_V0092</xsl:element>
        <xsl:element name="CcmFifFindServCharValueForServCharInCont">
          <xsl:element name="service_ticket_position_id_ref">
            <xsl:element name="command_id">find_most_recent_stp</xsl:element>
            <xsl:element name="field_name">service_ticket_position_id</xsl:element>          
      ...
      <xsl:element name="CcmFifFindServCharValueForServCharCmd">
        <xsl:element name="command_id">find_V0875</xsl:element>
        <xsl:element name="CcmFifFindServCharValueForServCharInCont">
          <xsl:element name="service_ticket_position_id_ref">
            <xsl:element name="command_id">find_most_recent_stp</xsl:element>
            <xsl:element name="field_name">service_ticket_position_id</xsl:element>          
      ...
      <xsl:element name="CcmFifFindServCharValueForServCharCmd">
        <xsl:element name="command_id">find_V0876</xsl:element>
        <xsl:element name="CcmFifFindServCharValueForServCharInCont">
          <xsl:element name="service_ticket_position_id_ref">
            <xsl:element name="command_id">find_most_recent_stp</xsl:element>
            <xsl:element name="field_name">service_ticket_position_id</xsl:element>          
    ...
    <xsl:if test="$createDSL = 'Y'">
      ...
      <xsl:variable name="bandwidthServiceCode">
        <xsl:choose>
          <xsl:when test="request-param[@name='DSLBandwidth'] = 'DSL 500'">V0179</xsl:when>
          <xsl:when test="request-param[@name='DSLBandwidth'] = 'Premium'">V0116</xsl:when>
          <xsl:when test="request-param[@name='DSLBandwidth'] = 'Gold'">V0117</xsl:when>
          ...
          <xsl:when test="request-param[@name='DSLBandwidth'] = 'DSL 4000'">V0176</xsl:when>
          <xsl:when test="request-param[@name='DSLBandwidth'] = 'DSL 5000'">V0177</xsl:when>
          <xsl:when test="request-param[@name='DSLBandwidth'] = 'DSL 6000'">V0178</xsl:when>
          <xsl:when test="request-param[@name='DSLBandwidth'] = 'DSL 8000'">V0180</xsl:when>
          <xsl:when test="request-param[@name='DSLBandwidth'] = 'DSL 10000'">V018A</xsl:when>
          <xsl:when test="request-param[@name='DSLBandwidth'] = 'DSL 12000'">V018B</xsl:when>
          <xsl:when test="request-param[@name='DSLBandwidth'] = 'DSL 16000'">V018C</xsl:when>
          <xsl:when test="request-param[@name='DSLBandwidth'] = 'DSL 20000'">V018D</xsl:when>
      ...
      <xsl:element name="CcmFifCreateCustOrderInCont">
        ...
        <xsl:element name="provider_tracking_no">
          <xsl:choose>
            ...
            <xsl:otherwise>003t</xsl:otherwise>
          </xsl:choose>
        </xsl:element>
      ...
      <xsl:if test="request-param[@name='manualRollback'] = 'N'">
        <xsl:element name="CcmFifConcatStringsCmd">
          ...
          <xsl:element name="CcmFifConcatStringsInCont">
            <xsl:element name="input_string_list">
              <xsl:element name="CcmFifPassingValueCont">
                <xsl:element name="value">isdn</xsl:element>							
              </xsl:element>                
            </xsl:element>
          </xsl:element>
        </xsl:element>      
