<xsl:variable name="dataType">
  <xsl:choose>
    ...
    <xsl:when test="request-param[@name='parameterName'] = 'contractStartDate'">STRING</xsl:when>
...
<xsl:variable name="serviceCharCode">
  <xsl:choose>
    ...
    <xsl:when test="request-param[@name='parameterName'] = 'contractStartDate'">V0200</xsl:when>
    ...
    <xsl:when test="request-param[@name='parameterName'] = 'numberOfVoiceChannels'">VI146</xsl:when>
  </xsl:choose>
</xsl:variable>
...
<xsl:variable name="value">
  <xsl:choose>
    ...
    <xsl:when test="request-param[@name='parameterName'] = 'contractStartDate'">
      <xsl:choose>
