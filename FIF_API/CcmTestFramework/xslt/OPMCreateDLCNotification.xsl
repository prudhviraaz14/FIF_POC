        ...
        <xsl:element name="CcmFifCreateExternalNotificationInCont">
          ...
          <xsl:element name="parameter_value_list">                                                                                                  
            <xsl:element name="CcmFifParameterValueCont">
              ...
              <xsl:element name="parameter_value">OPM</xsl:element>
            </xsl:element>
            <xsl:element name="CcmFifParameterValueCont">
            ...
            <xsl:element name="CcmFifParameterValueCont">
              <xsl:element name="parameter_name">PRODUCT</xsl:element>
              <xsl:element name="parameter_value"><xsl:value-of select="request-param[@name='PRODUCT']"/></xsl:element>
            </xsl:element>  
          </xsl:element>     
        </xsl:element>
      </xsl:element>
