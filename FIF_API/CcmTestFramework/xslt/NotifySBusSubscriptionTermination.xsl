    ...
    <xsl:template match="request-params">
        ...
        <xsl:element name="Command_List">
            ...
            <xsl:if test="dateutils:matchPattern('[a-z,A-Z]{3}[0-9]{10}', request-param[@name='OMTSOrderID']) = 'Y'">
                ...
                <!-- check if provider change log exists  -->
                <xsl:element name="CcmFifGetProviderChangeLogCmd">
                    <xsl:element name="command_id">get_provider_change_log_0</xsl:element>
                    <xsl:element name="CcmFifGetProviderChangeLogInCont">
                        <xsl:element name="term_bar_code">
                            <xsl:value-of select="request-param[@name='OMTSOrderID']"/>
                        </xsl:element>                                                                        
                ...
                <xsl:if test="request-param[@name='REASON_RD'] = 'PROVIDER_CHANGE' or request-param[@name='REASON_RD'] = 'TAKEOVERCONTRACT' or request-param[@name='REASON_RD'] = 'TERMINATION'">                    
                <!-- activate termination bar code -->
                <xsl:element name="CcmFifGetProviderChangeLogCmd">
                ...
                <xsl:element name="CcmFifValidateAnotherCcmFifTransactionExistsCmd">
                      ...
                      <xsl:element name="CcmFifValidateAnotherCcmFifTransactionExistsInCont">
                            ...
                            <xsl:element name="action_name">notifySBusSubscriptionActivation</xsl:element> 
