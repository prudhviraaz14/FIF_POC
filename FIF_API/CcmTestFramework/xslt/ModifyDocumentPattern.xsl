	...
	<xsl:template match="request-params">
		...
		<xsl:element name="Command_List">
			...
			<xsl:variable name="desiredDate">
				<xsl:choose>
					<xsl:when test="request-param[@name='desiredDate'] = '' or dateutils:compareString(request-param[@name='desiredDate'], $today) = '-1'">
			...
			<!-- If documentPatternAction = ADD, creates a new document pattern with the provided parameters -->
			<xsl:for-each select="request-param-list[@name='documentPatternList']/request-param-list-item">
