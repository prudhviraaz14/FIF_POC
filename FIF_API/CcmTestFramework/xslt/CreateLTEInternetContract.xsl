...
<!--
  XSLT file for creating a LTE DSL contract
...
<xsl:stylesheet exclude-result-prefixes="dateutils" version="1.0"
	...
	<xsl:template match="request-params">
		...
		<xsl:element name="Command_List">
			...
			<xsl:variable name="productCode">I1208</xsl:variable>
			...
			<!-- add the new  bundle item of type LTELACCESS -->
			<xsl:element name="CcmFifModifyBundleItemCmd">
				...
				<xsl:element name="CcmFifModifyBundleItemInCont">
					...
					<xsl:element name="bundle_item_type_rd">LTEACCESS</xsl:element>
			...
			<!-- add the new  bundle item of type LTELONLINE -->
			<xsl:element name="CcmFifModifyBundleItemCmd">
				<xsl:element name="command_id">modify_bundle_item</xsl:element>
				<xsl:element name="CcmFifModifyBundleItemInCont">
					<xsl:element name="bundle_id_ref">
					...
					<xsl:element name="bundle_item_type_rd">LTEONLINE</xsl:element>
					<xsl:element name="supported_object_id_ref">
						<xsl:element name="command_id">add_main_service</xsl:element>
						<xsl:element name="field_name">service_subscription_id</xsl:element>
					</xsl:element>
			...
			<xsl:element name="CcmFifCreateContactCmd">
				...
				<xsl:element name="CcmFifCreateContactInCont">
					...
					<xsl:element name="contact_type_rd">CREATE_LTEDSL</xsl:element>
					<xsl:element name="short_description">LTE-INTERNET-Vertrag erstellt</xsl:element>
					<xsl:element name="description_text_list">
						<xsl:element name="CcmFifPassingValueCont">
							<xsl:element name="contact_text">
								<xsl:text>LTE-DSL-Vertrag erstellt.&#xA;Vertragsnummer: </xsl:text>
							</xsl:element>
						</xsl:element>
						<xsl:element name="CcmFifCommandRefCont">
							<xsl:element name="command_id">find_main_service</xsl:element>
