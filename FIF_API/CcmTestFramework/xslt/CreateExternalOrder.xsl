    ...
    <xsl:element name="Command_List">
      ...
      <xsl:element name="CcmFifCreateExternalOrderCmd">
        ...
        <xsl:element name="CcmFifCreateExternalOrderInCont">
          ...
          <xsl:element name="source_packet_rd">
            <xsl:value-of select="request-param[@name='sourcePacket']"/>
          </xsl:element>
          <xsl:element name="target_packet_rd">
            <xsl:value-of select="request-param[@name='targetPacket']"/>
          </xsl:element>
          <xsl:element name="previous_order_id">
            <xsl:value-of select="request-param[@name='previousOrderId']"/>
          </xsl:element>
          <xsl:element name="previous_order_pos_num">
            <xsl:value-of select="request-param[@name='previousOrderPositionNumber']"/>
          </xsl:element>
          <xsl:element name="previous_order_rule">
            <xsl:value-of select="request-param[@name='previousOrderRule']"/>
          </xsl:element>
        </xsl:element>
      </xsl:element>
    </xsl:element>
