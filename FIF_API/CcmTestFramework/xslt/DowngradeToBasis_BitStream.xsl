    ...
    <xsl:element name="CcmFifCloneOrderFormCmd">
      ...
      <xsl:element name="CcmFifCloneOrderFormInCont">
        ...
        <xsl:element name="target_product_type">Basis</xsl:element> 
     ...
     <!-- Add requested Service DSL Anschluss -->
     <xsl:element name="CcmFifAddServiceSubsCmd">
       ...
       <xsl:element name="CcmFifAddServiceSubsInCont">
         ...
         <xsl:choose>
           <xsl:when test="request-param[@name='DSLBandwidth'] = 'DSL 1000'">
             <xsl:element name="service_code">V0118</xsl:element>
           </xsl:when>
           <xsl:when test="request-param[@name='DSLBandwidth'] = 'DSL 1500'">
             <xsl:element name="service_code">V0117</xsl:element>
           </xsl:when>
           <xsl:when test="request-param[@name='DSLBandwidth'] = 'DSL 2000'">
             <xsl:element name="service_code">V0174</xsl:element>
           </xsl:when>
           <xsl:when test="request-param[@name='DSLBandwidth'] = 'DSL 3000'">
             <xsl:element name="service_code">V0175</xsl:element>
           </xsl:when>
           <xsl:when test="request-param[@name='DSLBandwidth'] = 'DSL 6000'">
             <xsl:element name="service_code">V0178</xsl:element>
           </xsl:when>
           <xsl:when test="request-param[@name='DSLBandwidth'] = 'DSL 16000'">
             <xsl:element name="service_code">V018C</xsl:element>
           </xsl:when>
           <xsl:when test="request-param[@name='DSLBandwidth'] = 'DSL 25000'">
             <xsl:element name="service_code">V018G</xsl:element>
           </xsl:when>
           <xsl:when test="request-param[@name='DSLBandwidth'] = 'DSL 50000'">
    ...
    <xsl:if test="request-param[@name='instantAccessOption'] != ''">
     ...
     <xsl:if test="$ProductCode = $ISDNProductCode">  
       ...
       <xsl:element name="CcmFifFindServiceSubsCmd">
         <xsl:element name="command_id">get_voice_data</xsl:element>
       ...
       <xsl:element name="CcmFifFindServiceSubsCmd">
         <xsl:element name="command_id">get_internet_data</xsl:element>
         <xsl:element name="CcmFifFindServiceSubsInCont">
           <xsl:element name="service_subscription_id_ref">
             <xsl:element name="command_id">find_bundle_2</xsl:element>
             <xsl:element name="field_name">supported_object_id</xsl:element>
     ...
     <xsl:if test="$ProductCode = $DSLProductCode"> 
     ...
     <xsl:if test="$ProductCode = $BitStreamDSLProductCode">  
       <!-- look for a Bit-DSL bundle (item) -->
       <xsl:element name="CcmFifFindBundleCmd">
         <xsl:element name="command_id">find_bundle_1</xsl:element>
         <xsl:element name="CcmFifFindBundleInCont">
      ...
      <xsl:element name="CcmFifCloneOrderFormCmd">
        ...
        <xsl:element name="CcmFifCloneOrderFormInCont">
          ...
          <xsl:element name="target_product_code">
            <xsl:value-of select="$BitStreamVoIPProductCode"/>
          </xsl:element>
          <xsl:element name="target_pricing_structure_code">
    ...
    <xsl:if test="$ProductCode = $BitStreamDSLProductCode"> 
      <!-- Terminate the Bit DSL Contract -->
    ...
    <xsl:element name="CcmFifCreateExternalNotificationCmd">
      ...
      <xsl:element name="CcmFifCreateExternalNotificationInCont">
        ...
        <xsl:element name="notification_action_name">DowngradeTobasis</xsl:element>
    ...
    <xsl:element name="CcmFifCreateContactCmd">
      <xsl:element name="CcmFifCreateContactInCont">
        ...
        <xsl:if test="request-param[@name='orderVariant'] != 'Technologiewechsel'"> 
          <xsl:element name="contact_type_rd">PROD_CHANGE</xsl:element>
          <xsl:element name="short_description">Produkt Wechsel</xsl:element>
        </xsl:if>   
        <xsl:if test="request-param[@name='orderVariant'] = 'Technologiewechsel'"> 
        ...
        <xsl:if test="request-param[@name='relocationType'] != ''">               
          ...
          <xsl:element name="short_description">Umzug mit Productwechsel</xsl:element>
        </xsl:if>
