...
<!--
  XSLT file for checking and updating Customer Access Classification
...
<xsl:stylesheet exclude-result-prefixes="dateutils" version="1.0"
  ...
  <xsl:template match="request-params">
    ...
    <xsl:element name="Command_List">
      ...
      <xsl:element name="CcmFifCheckCustomerAccessClassificationCmd">
        <xsl:element name="CcmFifCheckCustomerAccessClassificationInCont">
