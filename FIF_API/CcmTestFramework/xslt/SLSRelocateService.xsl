  ...
  <xsl:template match="request-params">
    ...
    <xsl:element name="Command_List">
      ...
      <xsl:variable name="oneDayBefore"
        select="dateutils:createFIFDateOffset(request-param[@name='RELOCATION_DATE'], 'DATE', '-1')"/>
      <!-- Convert the termination date to OPM format -->
      <xsl:variable name="RELOCATION_DATEOPM"
        select="dateutils:createOPMDate(request-param[@name='RELOCATION_DATE'])"/>
        ...
        <xsl:element name="CcmFifRaiseErrorCmd">
          ...
          <xsl:element name="CcmFifRaiseErrorInCont">
            <xsl:element name="error_text">At least one of the following params must be provided:
              ACCESS_NUMBER, SERVICE_TICKET_POSITION_ID or SERVICE_SUBSCRIPTION_ID.</xsl:element>
          </xsl:element>
        </xsl:element>
      </xsl:if>
      ...
      <xsl:if test="request-param[@name='CHANGE_BILLING_ADDRESS'] = 'Y'">
        <xsl:element name="CcmFifGetBillingAddressCmd">
          ...
          <xsl:element name="CcmFifGetBillingAddressInCont">
            ...
            <xsl:element name="effective_date">
              <xsl:value-of select="request-param[@name='RELOCATION_DATE']"/>
            </xsl:element>
          </xsl:element>
        </xsl:element>
      </xsl:if>
        ...
        <xsl:element name="CcmFifModifyAddressCmd">
          ...
          <xsl:element name="CcmFifModifyAddressInCont">
            ...
            <xsl:element name="street_name">
              <xsl:value-of select="request-param[@name='NEW_STREET']"/>
            </xsl:element>
            <xsl:element name="street_number">
              <xsl:value-of select="request-param[@name='NEW_NUMBER']"/>
            </xsl:element>
            <xsl:element name="street_number_suffix">
              <xsl:value-of select="request-param[@name='NEW_NUMBER_SUFFIX']"/>
            </xsl:element>
            <xsl:element name="postal_code">
              <xsl:value-of select="request-param[@name='NEW_POSTAL_CODE']"/>
            </xsl:element>
            <xsl:element name="city_name">
              <xsl:value-of select="request-param[@name='NEW_CITY']"/>
            </xsl:element>
            <xsl:element name="city_suffix_name">
              <xsl:value-of select="request-param[@name='NEW_CITY_SUFFIX']"/>
            </xsl:element>
          </xsl:element>
        </xsl:element>
      </xsl:if>
      ...
      <xsl:if test="request-param[@name='CHANGE_CUSTOMER_ADDRESS'] = 'Y'">
        <xsl:element name="CcmFifModifyAddressCmd">
      ...
      <xsl:element name="CcmFifCloneProductSubsCmd">
        ...
        <xsl:element name="CcmFifCloneProductSubsInCont">
          ...
          <xsl:element name="service_code_list">
            ...
            <xsl:for-each select="request-param-list[@name='NEW_SERVICE_CODE_LIST']/request-param-list-item">
          ...
          <xsl:element name="service_characteristic_list">
            ...
            <xsl:if test="(request-param-list[@name='NEW_SERVICE_CODE_LIST']/request-param-list-item/request-param[@name='SERVICE_CODE'][.='V0010'])
                          or (request-param-list[@name='NEW_SERVICE_CODE_LIST']/request-param-list-item/request-param[@name='SERVICE_CODE'][.='V0011'])">
              <!-- Alter Anschluss -->
              ...
              <xsl:element name="CcmFifConfiguredValueCont">
                ...
                <xsl:element name="data_type">STRING</xsl:element>
                <xsl:if test="request-param[@name='RELOCATION_TYPE'] = 'Umzug ohne Rufnummernmitnahme'">
                  <xsl:element name="configured_value">Umzug ohne Rufnummernübernahme</xsl:element>
                </xsl:if>
                <xsl:if test="request-param[@name='RELOCATION_TYPE'] = 'Umzug mit Rufnummernmitnahme'">
              ...
              <xsl:element name="CcmFifConfiguredValueCont">
                ...
                <xsl:element name="data_type">STRING</xsl:element>
                <xsl:element name="configured_value">
                  <xsl:value-of select="$RELOCATION_DATEOPM"/>
                </xsl:element>
              </xsl:element>
              ...
              <xsl:element name="CcmFifConfiguredValueCont">
                ...
                <xsl:element name="data_type">STRING</xsl:element>
                <xsl:element name="configured_value">
                  <xsl:value-of select="request-param[@name='ASB_NUMBER']"/>
                </xsl:element>
              </xsl:element>
              ...
              <!-- Leitungstyp -->
              <xsl:if test="request-param[@name='LINE_TYPE'] != ''">
                <xsl:element name="CcmFifConfiguredValueCont">
                  <xsl:element name="service_char_code">V0138</xsl:element>
                  <xsl:element name="data_type">STRING</xsl:element>
                  <xsl:element name="configured_value">
                    <xsl:value-of select="request-param[@name='LINE_TYPE']"/>
                  </xsl:element>
                </xsl:element>
              </xsl:if>
              ...
              <xsl:element name="CcmFifConfiguredValueCont">
                ...
                <xsl:if test="request-param[@name='CARRIER'] = 'ISIS'">
                  <xsl:if test="request-param[@name='PROVISIONING_PROVIDER'] = 'ISIS'">
				    <xsl:element name="configured_value">ISIS</xsl:element>
   		          </xsl:if>				  
                  <xsl:if test="request-param[@name='PROVISIONING_PROVIDER'] = 'Arcor'">
                  	<xsl:if test="request-param[@name='LINE_TYPE'] = 'CuDa'">
				      <xsl:element name="configured_value">Arcor</xsl:element>
				    </xsl:if>
				    <xsl:if test="request-param[@name='LINE_TYPE'] != 'CuDa'">  
				      <xsl:element name="configured_value">ISIS</xsl:element>
            ...
            <xsl:if test="request-param-list[@name='NEW_SERVICE_CODE_LIST']/request-param-list-item/request-param[@name='SERVICE_CODE'][.='V0011']">
              <xsl:if test="request-param[@name='RELOCATION_TYPE'] = 'Umzug ohne Rufnummernmitnahme'">
                <!-- Access Number Range -->
                <xsl:element name="CcmFifAccessNumberCont">
            ...
            <xsl:if test="(request-param-list[@name='NEW_SERVICE_CODE_LIST']/request-param-list-item/request-param[@name='SERVICE_CODE'][.='V0010'])
                          or (request-param-list[@name='NEW_SERVICE_CODE_LIST']/request-param-list-item/request-param[@name='SERVICE_CODE'][.='V0011'])
                          or (request-param-list[@name='NEW_SERVICE_CODE_LIST']/request-param-list-item/request-param[@name='SERVICE_CODE'][.='V0012'])
                          or (request-param-list[@name='NEW_SERVICE_CODE_LIST']/request-param-list-item/request-param[@name='SERVICE_CODE'][.='V0013'])
                          or (request-param-list[@name='NEW_SERVICE_CODE_LIST']/request-param-list-item/request-param[@name='SERVICE_CODE'][.='V0014'])
                          or (request-param-list[@name='NEW_SERVICE_CODE_LIST']/request-param-list-item/request-param[@name='SERVICE_CODE'][.='V0015'])
                          or (request-param-list[@name='NEW_SERVICE_CODE_LIST']/request-param-list-item/request-param[@name='SERVICE_CODE'][.='V0016'])">
              <!-- Bemerkung -->
              <xsl:element name="CcmFifConfiguredValueCont">
            ...
            <xsl:if test="(request-param-list[@name='NEW_SERVICE_CODE_LIST']/request-param-list-item/request-param[@name='SERVICE_CODE'][.='V0010'])
              ...
              <xsl:element name="CcmFifConfiguredValueCont">
                ...
                <xsl:element name="data_type">STRING</xsl:element>
                <xsl:element name="configured_value">
                  <xsl:value-of select="request-param[@name='TAE_TYPE']"/>
                </xsl:element>
              </xsl:element>
            </xsl:if>

            <!-- Characteristics for service code V0100 -->
            <xsl:if test="(request-param-list[@name='NEW_SERVICE_CODE_LIST']/request-param-list-item/request-param[@name='SERVICE_CODE'][.='V0100'])">
              <!-- Directory Entry -->
      ...
      <xsl:element name="CcmFifTerminateProductSubsCmd">
        ...
        <xsl:if test="request-param[@name='TERMINATE_VOIP'] != 'Y'">    
            ...
            <xsl:element name="CcmFifCreateContactCmd">
              <xsl:element name="CcmFifCreateContactInCont">
                ...
                <xsl:element name="description_text_list">
                  ...
                  <xsl:element name="CcmFifPassingValueCont">
                    <xsl:element name="contact_text">
                      <xsl:text>&#xA;SERVICE_SUBSCRIPTION_ID: </xsl:text>
                    </xsl:element>
                  </xsl:element>
                  <xsl:element name="CcmFifCommandRefCont">
                    <xsl:element name="command_id">find_service_2</xsl:element>
