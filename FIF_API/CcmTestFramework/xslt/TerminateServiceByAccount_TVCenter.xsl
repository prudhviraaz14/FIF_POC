...
<xsl:element name="CcmFifFindServiceSubsCmd">
	<xsl:element name="command_id">find_service_tv_center_1</xsl:element>
...
<xsl:element name="CcmFifCancelNonCompleteStpForProductCmd">
	<xsl:element name="command_id">find_cancel_stp_tv_center_1</xsl:element>
...
<xsl:element name="CcmFifTerminateOrderFormCmd">
	<xsl:element name="command_id">terminate_of_tv_center_1</xsl:element>
...
<xsl:element name="CcmFifReconfigServiceCmd">
	<xsl:element name="command_id">reconf_serv_tv_center_1</xsl:element>
...
<xsl:element name="CcmFifTerminateProductSubsCmd">
	<xsl:element name="command_id">terminate_ps_tv_center_1</xsl:element>
...
<xsl:element name="CcmFifCreateCustOrderCmd">
	<xsl:element name="command_id">create_co_reconf_tv_center_1</xsl:element>
...
<xsl:element name="CcmFifCreateCustOrderCmd">
	<xsl:element name="command_id">create_co_term_tv_center_1</xsl:element>
	<xsl:element name="CcmFifCreateCustOrderInCont">
		<xsl:element name="customer_number_ref">
			<xsl:element name="command_id">find_service_tv_center_1</xsl:element>
			<xsl:element name="field_name">customer_number</xsl:element>
