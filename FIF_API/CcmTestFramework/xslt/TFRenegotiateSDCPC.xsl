  ...
  <xsl:template match="request-params">
    ...
    <xsl:element name="Command_List">
      ...
      <xsl:element name="CcmFifRenegotiateSDCProductCommitmentCmd">
        <xsl:element name="command_id">renegotiate_sdcpc_1</xsl:element>
        <xsl:element name="CcmFifRenegotiateSDCProductCommitmentInCont">
          ...
          <xsl:for-each
            select="request-param-list[@name='RenegotiateParam']/request-param-list-item/request-param-list[@name='ProductCommitList']/request-param-list-item">
