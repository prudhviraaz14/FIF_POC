    ...
    <xsl:element name="CcmFifCloneOrderFormCmd">
      ...
      <xsl:element name="CcmFifCloneOrderFormInCont">
        ...
        <xsl:element name="service_characteristic_list">
          ...
          <!-- Kundenzustimmung Teilstorno Multimedia -->          
          <xsl:element name="CcmFifConfiguredValueCont">
     ...
     <xsl:element name="CcmFifCreateCustOrderCmd">
       ...
       <xsl:element name="CcmFifCreateCustOrderInCont">
         ...
         <xsl:element name="provider_tracking_no">
           <xsl:choose>
             <xsl:when test="request-param[@name='providerTrackingNumberTVCenterTarget'] != ''">
               <xsl:value-of select="request-param[@name='providerTrackingNumberTVCenterTarget']" />
             </xsl:when>
             <xsl:otherwise>003h</xsl:otherwise>
           </xsl:choose>
         </xsl:element>         
    ...
    <!-- Terminate the TV-Center Product -->   
