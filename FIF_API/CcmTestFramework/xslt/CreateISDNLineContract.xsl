...
<!--
    XSLT file for creating ISDN line
        ...
        <xsl:element name="Command_List">
                    ...
                    <lineCreation orderPositionNumber="1">
                        ...
                        <accesses>
                            <xsl:call-template name="PrintFunctionNode">
                                ...
                                <xsl:with-param name="AccessRef" select="'access-isdn'"/>
                            </xsl:call-template>
                        </accesses>
                        <!-- functions -->
                        <functions>
            ...
            <xsl:element name="CcmFifCreateContactCmd">
                ...
                <xsl:element name="CcmFifCreateContactInCont">
                    ...
                    <xsl:element name="short_description">ISDN-Neuanlage über COM</xsl:element>
                    <xsl:element name="long_description_text">
                        <xsl:text>Auftrag  </xsl:text>
                        <xsl:value-of select="$orderID"/>
                        <xsl:text> für ISDN-Neuanschaltung wurde an COM gesendet.</xsl:text>                      
