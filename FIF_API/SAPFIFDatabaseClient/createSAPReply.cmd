@echo off
REM ---------------------------------------------------------------------------
REM NT script for launching the ExportDBStatusToCSV application
REM
REM $Author:   goethalo  $
REM $Revision:   1.3  $
REM
REM History:
REM $Log:   F:/GRUPPEN/PROJEKTE/PVCS_FIF/archives/FIF/SAPFIFDatabaseClient/createSAPReply.cmd-arc  $
REM  
REM     Rev 1.3   Aug 02 2004 15:29:46   goethalo
REM  SPN-FIF-000024410: Oracle 9i migration.
REM  
REM     Rev 1.2   Mar 03 2004 16:30:56   goethalo
...
%JAVA_HOME%\bin\java -Dfif.propertyfile=%~dp0etc\ExportDBStatusToCSV.properties -Dfif.clientpropertyfile=%~dp0etc\SAPFIFDatabaseClient.properties -cp %CP% net.arcor.fif.apps.ExportDBStatusToCSV %*
endlocal
