#!/usr/bin/sh
# ---------------------------------------------------------------------------
# Shell script for launching the SAP-FIF database client
#
# $Author:   goethalo  $
# $Revision:   1.2  $
# 
# History:
# $Log:   F:/GRUPPEN/PROJEKTE/PVCS_FIF/archives/FIF/SAPFIFDatabaseClient/runSAPFIFDatabaseClient.sh-arc  $
# 
#    Rev 1.2   Aug 02 2004 15:29:48   goethalo
# SPN-FIF-000024410: Oracle 9i migration.
# 
#    Rev 1.1   Mar 02 2004 11:19:32   goethalo
...
$JAVA_HOME/bin/java -Dfif.propertyfile=$PWD/etc/SAPFIFDatabaseClient.properties -cp $CPATH net.arcor.fif.client.DatabaseClient
