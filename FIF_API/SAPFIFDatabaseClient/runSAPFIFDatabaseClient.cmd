@echo off
REM ---------------------------------------------------------------------------
REM NT script for launching the SAP-FIF database client
REM
REM $Author:   goethalo  $
REM $Revision:   1.3  $
REM
REM History:
REM $Log:   F:/GRUPPEN/PROJEKTE/PVCS_FIF/archives/FIF/SAPFIFDatabaseClient/runSAPFIFDatabaseClient.cmd-arc  $
REM  
REM     Rev 1.3   Aug 02 2004 15:29:48   goethalo
REM  SPN-FIF-000024410: Oracle 9i migration.
REM  
REM     Rev 1.2   Mar 03 2004 16:31:02   goethalo
...
%JAVA_HOME%\bin\java -Dfif.propertyfile=%~dp0etc\SAPFIFDatabaseClient.properties -cp %CP% net.arcor.fif.client.DatabaseClient %*
endlocal
