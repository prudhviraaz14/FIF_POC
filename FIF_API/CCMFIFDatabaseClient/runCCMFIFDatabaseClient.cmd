@echo off
REM ---------------------------------------------------------------------------
REM NT script for launching the CCM-FIF database client
REM
REM $Author:   schwarje  $
REM $Revision:   1.3  $
REM
REM History:
REM $Log:   //PVCS_FIF/archives/FIF_API/CCMFIFDatabaseClient/runCCMFIFDatabaseClient.cmd-arc  $
REM   
REM      Rev 1.3   Jun 01 2010 18:25:34   schwarje
REM   IT-26029: updates
REM   
REM      Rev 1.2   Jul 30 2007 15:28:06   schwarje
REM   IT-19536: added new library to classpath
REM   
REM      Rev 1.1   Aug 02 2004 15:28:44   goethalo
REM   SPN-FIF-000024410: Oracle 9i migration.
REM   
REM      Rev 1.0   May 26 2004 19:09:16   makuier
...
%JAVA_HOME%\bin\java -Dfif.propertyfile=%~dp0etc\CCMFIFDatabaseClient.properties -cp %CP% net.arcor.fif.client.SynchronousDatabaseClient %*
endlocal
