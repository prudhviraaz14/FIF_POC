                        ...
                        <xsl:element name="CcmFifProcessServiceBusRequestCmd">
                            ...
                            <xsl:element name="CcmFifProcessServiceBusRequestInCont">
                                <xsl:element name="package_name"
                                    >net.arcor.com.epsm_com_001</xsl:element>
                                ...
                                <xsl:element name="parameter_value_list">
                                    ...
                                    <xsl:element name="CcmFifParameterValueCont">
                                        <xsl:element name="parameter_name"
                                            >BetroffenesObjekt</xsl:element>
                                        <xsl:element name="parameter_value"
                                            >SERVICE_SUBSCRIPTION</xsl:element>
                                    </xsl:element>
                                    <xsl:element name="CcmFifParameterValueCont">
                                    ...
                                    <xsl:if
                                        test="request-param[@name='COM_ORDER_POSITION_NUMBER'] != ''">
                                        <xsl:element name="CcmFifParameterValueCont">
                                            <xsl:element name="parameter_name"
                                                >AuftragPositionNummer</xsl:element>
                                            <xsl:element name="parameter_value">
                                                <xsl:value-of
                                                    select="request-param[@name='COM_ORDER_POSITION_NUMBER']"
                                                />
                                            </xsl:element>
                                        </xsl:element>
                                    </xsl:if>
